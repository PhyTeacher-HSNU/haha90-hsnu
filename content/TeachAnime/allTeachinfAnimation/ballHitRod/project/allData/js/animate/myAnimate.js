...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	// UI
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(1541.825,31.675);

	this.btn03 = new lib.theButton();
	this.btn03.name = "btn03";
	this.btn03.parent = this;
	this.btn03.setTransform(1466.85,788.25,0.8,0.8);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft},{t:this.btn03},{t:this.shape}]}).wait(1));
