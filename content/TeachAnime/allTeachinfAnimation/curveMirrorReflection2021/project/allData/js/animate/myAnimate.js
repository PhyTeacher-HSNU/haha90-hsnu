...
(lib.title = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFF00").s().p("");
	this.shape.setTransform(1.025,0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FF0000").ss(6,1,1).p("");
	this.shape_1.setTransform(1.025,0.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(1.025,0.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.title, new cjs.Rectangle(-149.5,-30.6,301.1,61.3), null);
...
(lib.man01 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#00FFFF").ss(5,1,1).p("AAXomQgXAGgbAAQhWAAg9g9Qg9g9AAhWQAAhWA9g9QA9g9BWAAQBVAAA9A9QA9A9AABWQAABWg9A9QgqAqg2ANIASBuABEkRICohXIjDhQIAbCnIAAHiIjtEaICCHWABEkRIhvA5ABEDRIh1EaICBHW");
...
(lib.cross = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#00FFFF").ss(3,1,1).p("AD6AAIj6AAIAAD6AAAAAIj5AAAAAj5IAAD5");
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#003300","#006600"],[0,1],0,447,0,-446.9).s().p("Eh8/BGUMAAAiMnMD5/AAAMAAACMng");
	this.shape_1.setTransform(800,450);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(0,0,1600,900), null);
...
(lib.box = function(mode,startPosition,loop) {
	...
	// ball
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("AnzH0IAAvnIPnAAIAAPng");
	this.shape.setTransform(0.025,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.box, new cjs.Rectangle(-49.9,-81.3,149.9,131.3), null);
...
(lib.helper = function(mode,startPosition,loop) {
	...
	this.instance = new lib.man02();
	this.instance.parent = this;
	this.instance.setTransform(993.65,632.5);

	this.instance_1 = new lib.man01();
	this.instance_1.parent = this;
	this.instance_1.setTransform(921.9,632.5);

	this.instance_2 = new lib.cross();
	this.instance_2.parent = this;
	this.instance_2.setTransform(944.75,306);

	this.instance_3 = new lib.bar();
	this.instance_3.parent = this;
	this.instance_3.setTransform(769.75,417.25);
	...
	this.shape_106.graphics.f("#FFFFFF").s().p("");
	this.shape_106.setTransform(305.8257,456.0447);

	this.shape_107 = new cjs.Shape();
	this.shape_107.graphics.f("#FFFFFF").s().p("");
	this.shape_107.setTransform(273.4702,455.7379);
...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.title.setTransform(802.95,450,4.5,4.4998,0,0,0,1,0);

	this.ligBtnB = new lib.sliderButton();
	this.ligBtnB.name = "ligBtnB";
	this.ligBtnB.parent = this;
	this.ligBtnB.setTransform(31.75,209.25);
	new cjs.ButtonHelper(this.ligBtnB, 0, 1, 2, false, new lib.sliderButton(), 3);

	this.ligBtnA = new lib.sliderButton();
	this.ligBtnA.name = "ligBtnA";
	this.ligBtnA.parent = this;
	this.ligBtnA.setTransform(31.75,155.6);
	new cjs.ButtonHelper(this.ligBtnA, 0, 1, 2, false, new lib.sliderButton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.ligBtnA},{t:this.ligBtnB},{t:this.title}]}).wait(1));
	...
	// ball
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(1515.4,858.25,0.81,0.8,0,0,0,0.1,0.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(1428.95,47.975);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(1411.025,286.875);

	this.rb05 = new lib.theRadioButton();
	this.rb05.name = "rb05";
	this.rb05.parent = this;
	this.rb05.setTransform(1400,400);

	this.rb04 = new lib.theRadioButton();
	this.rb04.name = "rb04";
	this.rb04.parent = this;
	this.rb04.setTransform(1400,340);

	this.rb03 = new lib.theRadioButton();
	this.rb03.name = "rb03";
	this.rb03.parent = this;
	this.rb03.setTransform(1400,220);

	this.rb02 = new lib.theRadioButton();
	this.rb02.name = "rb02";
	this.rb02.parent = this;
	this.rb02.setTransform(1400,160);

	this.rb01 = new lib.theRadioButton();
	this.rb01.name = "rb01";
	this.rb01.parent = this;
	this.rb01.setTransform(1400,100);
	...
	this.ch02.setTransform(1467.2,588.6,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1467.2,528.6,1,1,0,0,0,67.2,-1.4);

	this.sl03 = new lib.theSlider();
	this.sl03.name = "sl03";
	this.sl03.parent = this;
	this.sl03.setTransform(1802.65,283.45);

	this.sl02 = new lib.theSlider();
	this.sl02.name = "sl02";
	this.sl02.parent = this;
	this.sl02.setTransform(1802.65,202.95);

	this.sl01 = new lib.theSlider();
	this.sl01.name = "sl01";
	this.sl01.parent = this;
	this.sl01.setTransform(1400,460);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#000000","rgba(0,0,0,0.6)"],[0,1],-150,0,150,0).s().p("EgXbBOIMAAAicPMAu3AAAMAAACcPg");
	this.shape_3.setTransform(1490,480);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.btnUp},{t:this.btnLeft},{t:this.btnDown},{t:this.btnRight},{t:this.rb01},{t:this.rb02},{t:this.rb03},{t:this.rb04},{t:this.rb05},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(1212.475,351.35);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(1187.025,351.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAfBRQgfgSgQgkIAMgFQANAaARANQAbgOAbgYIAKAIQgSATgiAUQAgASAqAJIgIAMQgqgKgfgSgAhSBgQAFgCAAgEIAAhQIgjAAIAAgLIApAAIAAhrICpAAIAAAMIibAAIAAAXICNAAIAAANIiNAAIAAAXICNAAIAAAMIiNAAIAAAYICqAAIAAALIixAAIAABRQAagHAhgNIADANQgoAPgjAKg");
	this.shape_6.setTransform(1213.025,250.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(1186.95,250);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(1213.375,150);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(1187.125,150.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.textAA},{t:this.textLambda},{t:this.textTT},{t:this.bg}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(800,430,1276.6999999999998,667);
// library properties:
lib.properties = {
