...
(lib.btn01 = function(mode,startPosition,loop) {
	...
	// text
	this.label = new cjs.Text("按鈕01", "36px 'Microsoft JhengHei'", "#FFFFFF");
...
(lib.theCheckbox = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		ch.btnS.alpha=0;
		//click
		ch.btnS.on('click',function(e){//原本這裡沒有btnS，原本是 ch.on
								//按下設值
								ch.ched=!ch.ched;
								ch.checker.visible=ch.ched;
							});
...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btn04 = new lib.theButton();
	this.btn04.name = "btn04";
	this.btn04.parent = this;
	this.btn04.setTransform(1500,600);

	this.btn03 = new lib.theButton();
	this.btn03.name = "btn03";
	this.btn03.parent = this;
	this.btn03.setTransform(1350,600);
	...
	this.ch05 = new lib.theCheckbox();
	this.ch05.name = "ch05";
	this.ch05.parent = this;
	this.ch05.setTransform(430,310,1,1,0,0,0,67.2,-1.4);

	this.ch04 = new lib.theCheckbox();
	this.ch04.name = "ch04";
	this.ch04.parent = this;
	this.ch04.setTransform(430,410,1,1,0,0,0,67.2,-1.4);
	
	this.ch03 = new lib.theCheckbox();
	this.ch03.name = "ch03";
	this.ch03.parent = this;
	this.ch03.setTransform(1430,410,1,1,0,0,0,67.2,-1.4);
	
	this.ch02 = new lib.theCheckbox();
	this.ch02.name = "ch02";
	this.ch02.parent = this;
	this.ch02.setTransform(1430,340,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1430,270.4,1,1,0,0,0,67.2,-1.4);

	this.sl09 = new lib.theSlider();
	this.sl09.name = "sl09";
	this.sl09.parent = this;
	this.sl09.setTransform(150,490);
	
	this.sl08 = new lib.theSlider();
	this.sl08.name = "sl08";
	this.sl08.parent = this;
	this.sl08.setTransform(150,400);

	this.sl07 = new lib.theSlider();
	this.sl07.name = "sl07";
	this.sl07.parent = this;
	this.sl07.setTransform(150,350);

	this.sl06 = new lib.theSlider();
	this.sl06.name = "sl06";
	this.sl06.parent = this;
	this.sl06.setTransform(150,250);
	
	this.sl05 = new lib.theSlider();
	this.sl05.name = "sl05";
	this.sl05.parent = this;
	this.sl05.setTransform(150,300);

	this.sl04 = new lib.theSlider();
	this.sl04.name = "sl04";
	this.sl04.parent = this;
	this.sl04.setTransform(150,200);
	
	this.sl03 = new lib.theSlider();
	this.sl03.name = "sl03";
	this.sl03.parent = this;
	this.sl03.setTransform(1350,235.45);

	this.sl02 = new lib.theSlider();
	this.sl02.name = "sl02";
	this.sl02.parent = this;
	this.sl02.setTransform(1350,172.95);

	this.sl01 = new lib.theSlider();
	this.sl01.name = "sl01";
	this.sl01.parent = this;
	this.sl01.setTransform(1350,92.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.sl04},{t:this.sl05},{t:this.sl06},{t:this.sl07},{t:this.sl08},{t:this.sl09},{t:this.ch01},{t:this.ch02},{t:this.ch03},{t:this.ch04},{t:this.ch05},{t:this.btn01},{t:this.btn02},{t:this.btn03},{t:this.btn04},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
