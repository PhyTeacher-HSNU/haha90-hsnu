...
(lib.slm1m2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// text
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(2,1,1).p("AikAAIFJAA");
	this.shape.setTransform(-39.95,-0.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-39.8,-2.475);
...
}).prototype = getMCSymbolPrototype(lib.slm1m2, new cjs.Rectangle(-57.4,-27.3,331.4,49.7), null);


(lib.slkk = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAcBdIgshFIgQAPIAAA2IgXAAIAAi5IAXAAIAABpIA1g2IAeAAIgzAxIA4BVg");
	this.shape.setTransform(-38.125,0.3);
...
}).prototype = getMCSymbolPrototype(lib.slkk, new cjs.Rectangle(-43.7,-16.5,317.7,33.1), null);


(lib.chSaparate = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// label
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(71.45,-0.325);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.chSaparate, new cjs.Rectangle(-23.8,-20.7,165.8,38.7), null);
...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btnReset.setTransform(1448.05,753);
	...
	this.btnPlayStop.setTransform(1448.05,678.2);
	...
	this.chSaparate = new lib.chSaparate();
	this.chSaparate.name = "chSaparate";
	this.chSaparate.parent = this;
	this.chSaparate.setTransform(1427.4,574.15,1,1,0,0,0,67.2,-1.4);

	this.slm1m2 = new lib.slm1m2();
	this.slm1m2.name = "slm1m2";
	this.slm1m2.parent = this;
	this.slm1m2.setTransform(1350,498.75);

	this.slkk = new lib.slkk();
	this.slkk.name = "slkk";
	this.slkk.parent = this;
	this.slkk.setTransform(1350,418.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.slkk},{t:this.slm1m2},{t:this.chSaparate},{t:this.slCameraRR},{t:this.btnPlayStop},{t:this.btnReset}]}).wait(1));
