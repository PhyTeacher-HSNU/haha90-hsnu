...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.ch04.setTransform(1267.2,378.6,1,1,0,0,0,67.2,-1.4);

	this.ch03 = new lib.theCheckbox();
	this.ch03.name = "ch03";
	this.ch03.parent = this;
	this.ch03.setTransform(1417.2,378.6,1,1,0,0,0,67.2,-1.4);
	...
	this.ch02.setTransform(1417.2,318.6,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1417.2,258.6,1,1,0,0,0,67.2,-1.4);

	this.sl02 = new lib.theSlider();
	this.sl02.name = "sl02";
	this.sl02.parent = this;
	this.sl02.setTransform(1350,180);

	this.sl01 = new lib.theSlider();
	this.sl01.name = "sl01";
	this.sl01.parent = this;
	this.sl01.setTransform(1350,100);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft},{t:this.ch03},{t:this.ch04}]}).wait(1));
