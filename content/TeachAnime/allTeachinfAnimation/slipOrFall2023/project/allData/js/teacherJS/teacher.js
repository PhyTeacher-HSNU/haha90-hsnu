...
//var canvasMatter = $('<canvas>').attr('width','1600px').attr('height','900px');//產生 canvas
...
$('#mainAnimation').append(canvas3D)/*.append(canvasMatter)*/.append(canvas2D);//將 canvas 加到 html 理
...
world3D.cameraPhi=-40*Math.PI/180;
//Three.js
world3D.scene = new THREE.Scene();
var scene = world3D.scene;
world3D.camera = new THREE.PerspectiveCamera( 22.5, 1600 / 900, 10, 10000 );
...
world3D.render = function() {
	//設定攝影機位置
	world3D.cameraRR=world2D.slCameraRR.value*2;
