...
var canvasCanvas = $('<canvas>').attr('width','1600px').attr('height','900px');//產生 canvas
//var canvasPixi = $('<canvas>').attr('width','1600px').attr('height','900px');//產生 canvas
var canvas2D = $('<canvas>').attr('width','1600px').attr('height','900px');//產生 canvas
$('#mainAnimation').append(canvasCanvas).append(canvas2D);//將 canvas 加到 html 理
