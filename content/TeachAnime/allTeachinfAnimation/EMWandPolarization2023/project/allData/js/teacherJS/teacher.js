...
world2D.scaleX=world2D.scaleY=1600/1600;
...
world3D.cameraPhi=-30*Math.PI/180;
//Three.js
world3D.scene = new THREE.Scene();
var scene = world3D.scene;
world3D.camera = new THREE.PerspectiveCamera( 45/2, 1600 / 900, 0.01, 100000 );
...
world3D.scene.add(directionalLight1).add(directionalLight2);
